(function() {
	...
	app.controller("learnCtrl", learnCtrl);

	//?apiKey=5178650f2fb747a1a4c48cf9b86bd154//

	function learnCtrl($scope, $http, $routeParams) {
		...
		$scope.searchDrinks = "";
		$scope.title = "learn ctrl";
		
		function init(){
			var promise = $http.jsonp("http://addb.absolutdrinks.com/tastes/"  + "/?apiKey=5178650f2fb747a1a4c48cf9b86bd154&callback=JSON_CALLBACK");
